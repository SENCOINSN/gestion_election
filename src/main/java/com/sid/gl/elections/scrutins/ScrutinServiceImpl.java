...
public class ScrutinServiceImpl implements ScrutinService {
    ...
    @Override
    public void validateOtp(String otp, String username, Long scrutinId) throws ElectionNotFoundException, NoSuchAlgorithmException, BadValidateException {
        ...
        Scrutin scrutin = scrutinRepository.findById(scrutinId).orElse(null);
